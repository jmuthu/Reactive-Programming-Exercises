...
class EpidemySuite extends FunSuite {
  ...
  // es.getHealthyNeighbors(7,7).foreach(println)
 //  es.getHealthyNeighbors(0,0).foreach(println)
 //  es.getHealthyNeighbors(7,0).foreach(println)
//   es.getHealthyNeighbors(0,7).foreach(println)
  // es.run
  }
 ...
 //   print (numInfected, es.SimConfig.population * prevalenceRate) 
